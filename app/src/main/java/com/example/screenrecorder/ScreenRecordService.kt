...
class ScreenRecordService : Service() {
    ...
    companion object {
        ...
        const val ACTION_RECORDING_STOPPED =
            "com.example.screenrecorder.RECORDING_STOPPED"
    ...
    private fun startRecording(resultCode: Int, data: Intent) {
        ...
        // The consent is validated by getMediaProjection above; only now can
        // the service start as foreground with the mediaProjection type on
        // Android 14 (starting it earlier would raise a SecurityException).
    ...
    private fun stopAndFinalize() {
        ...
        // its own end-of-stream. finalizeFile runs once both encoders report EOS.
    }
